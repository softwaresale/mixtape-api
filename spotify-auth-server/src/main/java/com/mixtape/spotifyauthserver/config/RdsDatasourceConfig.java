...
public class RdsDatasourceConfig {
    ...
    private static final Logger logger = LoggerFactory.getLogger(RdsDatasourceConfig.class);

    private final AwsConfigurationProperties awsConfigurationProperties;
    private final ObjectMapper objectMapper;

    public RdsDatasourceConfig(AwsConfigurationProperties awsConfigurationProperties, ObjectMapper objectMapper) {
    ...
    private Optional<RdsDbCredentials> getCredentials(SecretsManagerClient secretsManagerClient) {
        logger.info("Getting rds secret: {}", awsConfigurationProperties.getRdsSecretId());
        GetSecretValueRequest request = GetSecretValueRequest.builder()
                .secretId(awsConfigurationProperties.getRdsSecretId())
                .build();
