package com.mixtape.spotifyauthserver.data.authorization;

import java.time.Instant;

import com.mixtape.spotifyauthserver.data.authclient.AuthorizedClient;
...
/**
 * Entity that models an authorization. This is basically our side of an "authorized client of our system right now."
 * It has our access token, id token, refresh token, issuance info, user information, and much, much more. It is worth
 * mentioning that this model is distinct from {@link AuthorizedClient},
 * which has slightly confusing terminology
 *
 * @author Charlie Sale
 * @since 0.0.1
 */
