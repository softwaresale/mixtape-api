...
public class JpaOAuth2AuthorizedClientRepository implements OAuth2AuthorizedClientRepository {
    ...
    public JpaOAuth2AuthorizedClientRepository(JpaAuthorizedClientService authorizedClientService, ClientRegistrationRepository clientRegistrationRepository) {
    ...
    public <T extends OAuth2AuthorizedClient> T loadAuthorizedClient(String clientRegistrationId, Authentication principal, HttpServletRequest request) {
        ...
        Optional<AuthorizedClient> authorizedClientOpt = authorizedClientService.getMostRecentExclusive(clientRegistrationId, principal.getName());
    ...
    public void saveAuthorizedClient(OAuth2AuthorizedClient authorizedClient, Authentication principal, HttpServletRequest request, HttpServletResponse response) {
        ...
        authorizedClientService.saveExclusive(authClientEntity);
    }
    ...
    public void removeAuthorizedClient(String clientRegistrationId, Authentication principal, HttpServletRequest request, HttpServletResponse response) {
        ...
        authorizedClientService.remove(clientRegistrationId, principal.getName());
    }
}
